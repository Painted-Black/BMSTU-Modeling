...
%Рассмотрим график $F(t)$ на рисунке 21 с $t_{max} = 20$.
...
\newpage
\begin{figure}[!h]
	\center{\includegraphics[width=15cm]{nu10}}
	\caption{$\nu = 0.1, t_u = 5$.}
	\label{fig:nu10}
\end{figure}
...
\newpage
\begin{figure}[!h]
	\center{\includegraphics[width=15cm]{nu5}}
	\caption{$\nu = 0.2, t_u = 3$.}
	\label{fig:nu5}
\end{figure}
...
\newpage
\begin{figure}[!h]
	\center{\includegraphics[width=15cm]{nu1}}
	\caption{$\nu = 1, t_u = 0.9$.}
	\label{fig:nu1}
\end{figure}
...
\newpage
\begin{figure}[!h]
	\center{\includegraphics[width=15cm]{gr2}}
